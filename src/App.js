...
//import './App.css';
import React, { Component } from "react"; // Importa React la clase Component para crear un componente de clase.
...
class App extends Component {
  ...
  cambiarFiltro = (event) => {
   ...
   render() {
    ...
    if (this.state.filtro === "activos") return empleado.activo; //Muestra los empleados activos al seleccionar el filtro
    if (this.state.filtro === "inactivos") return !empleado.activo; //Muestra los empleados inactivos al seleccionar el filtro
    ...
    <CmpEmpleados empleados={empleadosFiltrados} cambiarEstado={this.cambiarEstadoEmpleado} /> {/*Llama al componente*/}
        </div> 
    );
  }
}
